...
export function MainDashboard({ onNavigateToLab }: { onNavigateToLab?: () => void } = {}) {
    ...
    <div style={{ padding: "var(--space-lg)", display: "grid", gap: "var(--space-lg)" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "var(--space-md)" }}>
          {onNavigateToLab && (
            <button className="btn-ghost" onClick={onNavigateToLab} style={{ fontSize: "0.8rem", padding: "0.35rem 0.7rem" }}>
              🔬 Strategy Lab
            </button>
          )}
          <Badge
